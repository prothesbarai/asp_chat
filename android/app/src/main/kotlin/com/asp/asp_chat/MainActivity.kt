...
class MainActivity: FlutterActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val badManufacturers = listOf("symphony", "walton", "tecno", "infinix", "itel", "lava", "karbonn", "micromax")
        ...
        val isBadDevice = badGpuVendors.any { gpuRenderer.contains(it) } || badManufacturers.any { manufacturer.contains(it) }
